(function exportController() {
    class Controller {
      constructor(ship) {
        this.ship = ship;
        console.log("constructor", this.ship);
        this.initialiseSea();
      ...
      renderMessage(message) {
        ...
        const messageContainer = document.querySelector('#headsUpBoard');
      ...
      setSail() {
        ...
        const sailButton = document.querySelector('#sailbutton');
        console.log(1, ship.currentPort.name)
        ...
        if (this.endOfItinerary) {
          ...
          const sailInterval = setInterval(() => {
            ...
            console.log(2, ship.currentPort.name)
            } else {
              posX += 1;
              shipElement.style.left = `${posX}px`;
            }
